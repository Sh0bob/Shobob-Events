...
function applyPatches(source, assets) {
  ...
  `aHg(22, "logo", 8, "${assets.partners}")`,
  "replace small logo with partner display"
);
  ...
  `textLength = 0.85 * aQZ.i / text.width;
vV.setTransform(textLength, 0, 0, textLength, aQZ.fB + 0.07 * aQZ.i, aQZ.fD - 450)`,
...
source = replaceOne(
  source,
  /this\.aDZ\s*=\s*"[^"]*"/,
  `this.aDZ = "https://discord.gg/vttfDmM8st"`,
